...
- W pierwszej rundzie rozpoczynający nie dobiera, a drugi gracz dobiera jedną kartę na początku swojej pierwszej tury. Od drugiej własnej tury obaj dobierają po dwie karty.
...
| Dobieranie | Drugi gracz obowiązkowo dobiera 1 w pierwszej własnej turze; od drugiej własnej tury obaj obowiązkowo po 2; dobrowolne jest tworzenie energii |
...
| `falballa` | Falballa | 2 / 2 | 2 | Przeciw męskiej postaci +2 ataku albo osłona 2; wybór postawy opisany niżej |
| `dobromina` | Dobromina | 1 / 3 | 2 | Jak Falballa, lecz przeciw wrogiemu Asparanoixowi premia wynosi 4 zamiast 2 |
...
## Falballa i Dobromina — robocze znaczenie „atak lub obrona”

Postawa startowa to **obrona**. Raz we własnej turze można bez kosztu zmienić
postawę na atak albo obronę. Wybrana postawa zostaje również na turę rywala;
nie ma osobnej interakcji gracza broniącego w środku wymiany. Blokada nie
pozwala zmieniać postawy. Domyślna postawa jest jawną decyzją modelu gry.

Przeciw męskiej postaci postawa ataku zwiększa zadawane obrażenia. Postawa
obrony pochłania do 2 (lub 4) obrażeń **w każdej wymianie**. To osłona,
nie trwałe zwiększenie HP, i nie leczy wcześniejszych obrażeń. Osłona działa
zarówno podczas atakowania, jak i bronienia. Przeciw kobietom, zwierzętom,
budowlom i graczowi premia nie działa. Dwa uderzenia Asterixa są dwiema
wymianami, więc osłona rozlicza się osobno przy każdym.

Ta interpretacja zapewnia użyteczny wybór obrony przy trwałych obrażeniach.
Jeśli planowałeś +2/+4 do maksymalnego życia lub wybór za każdym razem tuż
przed wymianą, trzeba zmienić silnik i ponownie uruchomić eksperymenty.

## Blokady, ochrona i usuwanie efektów

- Blokada uniemożliwia deklarowanie ataku i zmianę postawy. Nie wyłącza
  pasywnej trucizny, aury ani zdolności przy wejściu nowych kart.
