...
- **A38:** przejmuje wrogą jednostkę do końca bieżącej tury. Dostaje możliwość ataku nawet po wykorzystaniu wcześniejszego ataku; nadal obowiązują blokada i zakaz ataków w pierwszej turze gracza. Można ją poświęcić Brutusowi, ale tylko przed jej atakiem po przejęciu; nie można jej przepalić na energię. Jeśli przeżyje, wraca z obrażeniami i premiami; po śmierci trafia do stosu pierwotnego właściciela. Przejęcie odsłania jednostkę. Zmiana kontrolera Koloseum odsłania jego podopiecznych.
