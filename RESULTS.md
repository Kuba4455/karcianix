...
- Początkowe i maksymalne życie obu graczy: **15 HP**.
...
- Zachowano: dodatkową kartę drugiego gracza w pierwszej turze, później po dwie dla obu graczy; Gęsi 1/1 za 1.
...
```bash
npm run simulate -- --games 500 --seed 20260921 --out reports/v4-500
```

Weryfikacja wersji 0.4.0: **65 testów Vitest zaliczonych**, kontrola typów TypeScript bez błędów.
