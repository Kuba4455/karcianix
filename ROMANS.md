...
- **Brutus:** w swojej turze poświęć inną kontrolowaną jednostkę z pola, która jeszcze nie zaatakowała w tej turze. Wybierz trwałe +2/0, 0/+2 lub +1/+1 dla tego Brutusa. Bez kosztu energii i bez jej tworzenia, wielokrotnie, także w turze wejścia. Może poświęcić jednostkę przejętą przez A38, jeśli nie wykonała ataku po przejęciu. Poświęcona karta trafia na stos odrzuconych pierwotnego właściciela. Premię Brutusa usuwa Spadające niebo.
- **Antywirus:** jednorazowo przy zagraniu wybierz liczbę Legionistów z ręki (od zera do wszystkich) do wystawienia za darmo. Silnik nie ogranicza miejsc na stole. Legionistów obowiązuje zakaz atakowania tylko w pierwszej turze gracza rozpoczynającego.
- **A38:** przejmuje wrogą jednostkę do końca bieżącej tury. Dostaje możliwość ataku nawet po wykorzystaniu wcześniejszego ataku; nadal obowiązują blokada i zakaz ataków w pierwszej turze gracza rozpoczynającego. Można ją poświęcić Brutusowi, ale tylko przed jej atakiem po przejęciu; nie można jej przepalić na energię. Jeśli przeżyje, wraca z obrażeniami i premiami; po śmierci trafia do stosu pierwotnego właściciela. Przejęcie odsłania jednostkę. Zmiana kontrolera Koloseum odsłania jego podopiecznych.
